package com.rochon.car.manufacturer.ford.fusion;
...
public class FordFusion implements FordFusionCar {
	...
	private final FordFusionBody body;
	
	
	public FordFusion(PowerDoorLocks locks, Radio radio, Horn horn,
			DriveTrain driveTrain, BrakingSystem brakes, FordFusionBody body) {
		this.locks = locks;
		this.radio = radio;
		this.horn = horn;
